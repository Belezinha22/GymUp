...
export const plans = [
  {
    ...
    workouts: [
      { day: 'Treino A', exercise: 'Agachamento goblet', sets: '3 x 10', rest: '60 s', notes: 'Tronco firme e amplitude confortavel.', video: agachamentoLivreVideo, equipment: 'Halter', primaryMuscle: 'Quadriceps', secondaryMuscle: 'Gluteos e core', difficulty: 2.4, description: ['Segure o halter proximo ao peito.', 'Desca com o tronco firme e joelhos alinhados.', 'Suba empurrando o chao com os pes.'] },
      { day: 'Treino A', exercise: 'Supino reto', sets: '3 x 10', rest: '75 s', notes: 'Pes firmes no chao e controle na descida.', video: supinoVideo, equipment: 'Barra', primaryMuscle: 'Peito', secondaryMuscle: 'Triceps e ombro', difficulty: 2.7, description: ['Deite no banco com escapulas estaveis.', 'Desca a barra de forma controlada.', 'Empurre mantendo punhos alinhados.'] },
      { day: 'Treino B', exercise: 'Puxada frontal', sets: '3 x 12', rest: '60 s', notes: 'Puxe com as costas, nao apenas com os bracos.', video: puxadaFrontalVideo, equipment: 'Polia', primaryMuscle: 'Dorsal', secondaryMuscle: 'Biceps e antebraco', difficulty: 2.9, description: ['Mantenha o peito aberto.', 'Puxe a barra em direcao ao topo do peito.', 'Suba controlando sem perder postura.'] },
      { day: 'Treino B', exercise: 'Leg press', sets: '3 x 12', rest: '75 s', notes: 'Controle o movimento sem travar os joelhos.', video: legPressVideo, equipment: 'Maquina', primaryMuscle: 'Quadriceps', secondaryMuscle: 'Gluteos e posteriores', difficulty: 2.8, description: ['Apoie bem a lombar no encosto.', 'Empurre a plataforma com os pes inteiros.', 'Retorne com amplitude confortavel.'] },
    ],
  },
  {
    slug: 'hipertrofia',
    ...
    workouts: [
      ...
      { day: 'Peito e triceps', exercise: 'Crucifixo', sets: '3 x 12', rest: '60 s', notes: 'Amplitude confortavel sem perder o controle.', video: crucifixoVideo, equipment: 'Maquina', primaryMuscle: 'Peito', secondaryMuscle: 'Deltoide anterior', difficulty: 2.5, description: ['Mantenha cotovelos semi flexionados.', 'Abra o peito com controle.', 'Feche o movimento sentindo o peitoral.'] },
      { day: 'Costas e biceps', exercise: 'Remada curvada', sets: '4 x 10', rest: '90 s', notes: 'Mantenha o tronco estavel e puxe com as costas.', video: remadaCurvadaVideo, equipment: 'Barra', primaryMuscle: 'Costas', secondaryMuscle: 'Biceps e lombar', difficulty: 3.1, description: ['Incline o tronco mantendo coluna neutra.', 'Puxe a barra em direcao ao abdomen.', 'Desca sem relaxar a postura.'] },
      { day: 'Costas e biceps', exercise: 'Rosca direta', sets: '3 x 12', rest: '60 s', notes: 'Evite balancar o corpo.', video: roscaDiretaVideo, equipment: 'Barra', primaryMuscle: 'Biceps', secondaryMuscle: 'Antebraco', difficulty: 2.4, description: ['Cotovelos proximos ao corpo.', 'Suba sem impulsionar o tronco.', 'Desca de forma controlada.'] },
      { day: 'Pernas', exercise: 'Stiff', sets: '4 x 10', rest: '90 s', notes: 'Quadril para tras e coluna neutra.', video: stiffVideo, equipment: 'Barra', primaryMuscle: 'Posterior de coxa', secondaryMuscle: 'Gluteos e lombar', difficulty: 3.0, description: ['Desloque o quadril para tras.', 'Mantenha joelhos semi flexionados.', 'Suba contraindo gluteos e posteriores.'] },
    ],
  },
  {
    slug: 'emagrecimento',
  ...
  },
  {
    ...
    workouts: [
      { day: 'Potencia', exercise: 'Leg press explosivo', sets: '4 x 8', rest: '75 s', notes: 'Subida forte e descida controlada.', video: legPressVideo, equipment: 'Maquina', primaryMuscle: 'Quadriceps', secondaryMuscle: 'Gluteos', difficulty: 3.0, description: ['Empurre com intencao explosiva.', 'Controle completamente o retorno.', 'Mantenha joelhos alinhados.'] },
      { day: 'Potencia', exercise: 'Puxada frontal', sets: '4 x 10', rest: '60 s', notes: 'Controle escapular em toda a repeticao.', video: puxadaFrontalVideo, equipment: 'Polia', primaryMuscle: 'Dorsal', secondaryMuscle: 'Biceps', difficulty: 2.9, description: ['Ative escapulas antes de puxar.', 'Desca a barra ate o peito.', 'Suba sem perder tensao.'] },
      { day: 'Suporte', exercise: 'Elevacao lateral', sets: '3 x 15', rest: '45 s', notes: 'Evite impulso excessivo.', video: elevacaoLateralVideo, equipment: 'Halteres', primaryMuscle: 'Deltoide lateral', secondaryMuscle: 'Trapezio superior', difficulty: 2.6, description: ['Eleve os halteres ate a linha dos ombros.', 'Mantenha cotovelos levemente flexionados.', 'Nao use balanco para subir.'] },
    ],
  },
  {
    slug: 'bem-estar',
    ...
    workouts: [
      { day: 'Full body', exercise: 'Supino reto', sets: '3 x 12', rest: '60 s', notes: 'Carga confortavel e boa execucao.', video: supinoVideo, equipment: 'Barra', primaryMuscle: 'Peito', secondaryMuscle: 'Triceps', difficulty: 2.7, description: ['Mantenha os pes fixos no chao.', 'Desca controlando a barra.', 'Suba sem perder alinhamento.'] },
      { day: 'Full body', exercise: 'Triceps pulley', sets: '3 x 15', rest: '45 s', notes: 'Cotovelos estaveis e movimento limpo.', video: tricepsPulleyVideo, equipment: 'Polia', primaryMuscle: 'Triceps', secondaryMuscle: 'Antebraco', difficulty: 2.2, description: ['Cotovelos proximos ao corpo.', 'Empurre o cabo para baixo.', 'Retorne sem perder tensao.'] },
